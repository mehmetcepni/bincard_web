...
import 'react-toastify/dist/ReactToastify.css';
  ...
  const menuItems = [
  { text: 'Ana Sayfa', icon: '🏠', path: '/dashboard' },
  { text: 'Otobüs Seferleri', icon: '🚌', path: '/routes' },
  { text: 'Kartlarım', icon: '💳', path: '/cards' },
  { text: 'Geçmiş İşlemler', icon: '📜', path: '/history' },
  { text: 'Haberler', icon: '📰', path: '/news' },
  { text: 'Profilim', icon: '👤', path: '/profilim' },
  ];
